...
@set SDK_INSTALL_DIR=D:\iPaylabSDK

@set SDK_API_DIR=D:\iPaylabSDK\api\1.0.0\inc

@set SDK_LIB_DIR=D:\iPaylabSDK\api\1.0.0\LIB

@set SDK_SYS_LIB_DIR=D:\iPaylabSDK\api\1.0.0\syslib
...
@set CROSS_COMPILER_DIR=%SDK_INSTALL_DIR%\tools\cross-compiler\gcc7.2.0

@rem Set DEBUGGER_DIR
@set DEBUGGER_DIR=%SDK_INSTALL_DIR%\tools\debugger

@set LD_LIBRARY_PATH=D:\iPaylabSDK\tools\cross-compiler\gcc7.2.0\mips-linux-gnu\lib
